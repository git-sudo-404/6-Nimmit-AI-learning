  ...
  return (
    <>
      <div className=" mt-2.5 bg-black/01 p-1 px-1.5 grid grid-cols-12 gap-1 ml-2.5 mt-0.5 h-19/20 w-69/70 backdrop-blur-sm  justify-center items-center rounded-xl  border-black/20 border-2 shadow-lg shadow-black/30  ">
        ...
        <div className="hover:animate-bounce col-span-1 w-full h-full rounded-2xl bg-red-500 border border-dashed border-white text-2xl font-mono flex justify-center items-center hover:bg-white/30 hover:border-red-500 hover:text-red-500 hover:text-4xl transition-all ">
          {" "}
          AI
        </div>
